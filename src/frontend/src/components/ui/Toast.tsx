...
const typeConfig = {
  info: {
    ...
    glowColor: 'rgba(var(--spotlight-outline), 0.15)',
    progressColor: 'rgba(var(--spotlight-outline), 0.5)',
    ariaLabel: '信息提示',
  },
  success: {
    icon: CheckCircle,
    ...
    glowColor: 'rgba(var(--spotlight-ifline), 0.15)',
    progressColor: 'rgba(var(--spotlight-ifline), 0.5)',
    ariaLabel: '成功提示',
  },
  warning: {
    icon: AlertTriangle,
    ...
    glowColor: 'rgba(var(--spotlight-character), 0.15)',
    progressColor: 'rgba(var(--spotlight-character), 0.5)',
    ariaLabel: '警告提示',
  },
  error: {
    icon: AlertCircle,
