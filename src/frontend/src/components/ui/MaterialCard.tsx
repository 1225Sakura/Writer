...
export function MaterialCard({
  ...
  gradientFrom = 'color-mix(in srgb, var(--accent-100) 60%, transparent)',
  gradientVia = 'color-mix(in srgb, var(--color-location) 40%, transparent)',
  gradientTo = 'color-mix(in srgb, var(--color-character) 50%, transparent)',
