/**
 * GlassCard - Unified card component with multiple visual variants
 *
...
export type SpotlightColor = 'accent' | 'character' | 'item' | 'location' | 'faction' | 'outline' | 'ifline' | 'vermillion' | 'white'
...
const spotlightColorMap: Record<SpotlightColor, string> = {
  accent: '94, 106, 210',
...
const intensityStyles: Record<CardIntensity, CSSProperties> = {
  light: {
...
const lightIntensityStyles: Record<CardIntensity, CSSProperties> = {
  light: {
    background: 'var(--glass-bg-subtle)',
    backdropFilter: 'blur(8px) saturate(1.1)',
    WebkitBackdropFilter: 'blur(8px) saturate(1.1)',
...
const borderStyles: Record<CardBorder, CSSProperties> = {
...
const lightBorderStyles: Record<CardBorder, CSSProperties> = {
  none: { border: '1px solid transparent' },
  subtle: { border: '1px solid var(--glass-border)' },
  glow: {
    border: '1px solid var(--accent-muted)',
...
const spotlightIntensityMap: Record<string, { size: number; opacity: number }> = {
...
const premiumGlowIntensityMap: Record<string, { spread: number; opacity: number }> = {
...
const premiumRoundedMap: Record<string, string> = {
  sm: '8px',
  md: '12px',
  lg: '16px',
  xl: '20px',
...
const premiumPaddingMap: Record<string, string> = {
  none: '0',
  sm: '16px',
  md: '24px',
  lg: '32px',
...
/** @deprecated Use GlassCard with variant="glow" instead */
export function GlowCard(props: GlassCardProps) {
  return <GlassCard {...props} variant="glow" />
}

/** @deprecated Use GlassCard with variant="spotlight" instead */
export function SpotlightCard(props: GlassCardProps) {
  return <GlassCard {...props} variant="spotlight" />
}

/** @deprecated Use GlassCard with variant="gradient-border" instead */
export function PremiumCard(props: GlassCardProps) {
  return <GlassCard {...props} variant="gradient-border" />
}
