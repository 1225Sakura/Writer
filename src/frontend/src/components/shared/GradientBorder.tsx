...
const presetGradients: Record<GradientPreset, string[]> = {
  accent: ['rgba(94, 106, 210, 0.6)', 'rgba(94, 181, 166, 0.5)', 'rgba(232, 184, 125, 0.4)'],
  warm: ['rgba(232, 184, 125, 0.6)', 'rgba(196, 92, 92, 0.5)', 'rgba(212, 93, 93, 0.4)'],
  cool: ['rgba(94, 106, 210, 0.6)', 'rgba(91, 142, 232, 0.5)', 'rgba(94, 181, 166, 0.4)'],
  rainbow: [
    'rgba(94, 106, 210, 0.6)',
    'rgba(91, 142, 232, 0.5)',
    'rgba(94, 181, 166, 0.5)',
  ...
  ocean: ['rgba(91, 142, 232, 0.6)', 'rgba(94, 181, 166, 0.5)', 'rgba(94, 106, 210, 0.4)'],
  forest: ['rgba(126, 183, 74, 0.6)', 'rgba(94, 181, 166, 0.5)', 'rgba(94, 106, 210, 0.4)'],
  custom: ['rgba(94, 106, 210, 0.6)', 'rgba(94, 181, 166, 0.5)'],
}
