...
# When this file is imported under both 'models.extensions' and
# 'backend.models.extensions', Python executes it twice.  Reuse the
# already-executed module to prevent SQLAlchemy "table already defined"
# errors.
_ALIASES = ("models.extensions", "backend.models.extensions", "core.domain.extensions", "backend.core.domain.extensions")
...
# (end of if not _SKIP_DEFINITIONS block)
